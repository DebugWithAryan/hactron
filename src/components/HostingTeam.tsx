      ...
      members: [
        {
          ...
          showSocials: true,
          linkedin: "https://www.linkedin.com/in/shashwat1610/",  
          instagram: "#"  
        },
        {
          name: "Aryan Jaiswal",
          ...
          instagram: "https://www.instagram.com/aryan._eee/"  
        }
      ]
    },
    {
      ...
      members: [
        {
          ...
          image: SatyamKumar,
          showSocials: true,
          linkedin: "https://www.linkedin.com/in/isatyamks/",  // Replace with actual LinkedIn URL
          instagram: "https://www.instagram.com/isatyamks/"  // Replace with actual Instagram URL
        },
        {
          name: "Avinash Sharma",
          image: AvinashSharma,
          ...
          instagram: "https://www.instagram.com/avinash_coder/"
        },
        {
          name: "Soham Ghosh",
          image: Soham,
          ...
          instagram: "https://www.instagram.com/codingsohamg/"  
        }
      ]
    },
    {
      ...
      >
        ...
        {member.showSocials && (
          <div className="flex space-x-4 mt-2">
            {member.linkedin && (
              <a href={member.linkedin} target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-[#0077B5] transition-colors">
            ...
            {member.instagram && (
              <a href={member.instagram} target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-[#E1306C] transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
